...
public class AndroidXMLParsingActivity extends Activity implements OnItemClickListener {
 GridView mListView;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mRefresh.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mLoadRecipesTask.execute("http://gencaydeniz.com/gencaydeniz.com/anonymous/documents/list.xml");
            }
        });
        ...
        while (eventType != XmlPullParser.END_DOCUMENT) {
            if (eventType == XmlPullParser.START_TAG) {
                ...
                if ("fak".equals(xpp.getName())) {
                    results.add(new Datum(id, title, pen));
                }
            }
            eventType = xpp.next();
        }
    ...
    protected class LoadRecipesTask extends AsyncTask<String, Void, ArrayList<Datum>> {

        @Override
        protected void onPreExecute() {
        	AndroidXMLParsingActivity.this.setProgressBarIndeterminateVisibility(true);
        }
        ...
        protected void onPostExecute(ArrayList<Datum> result) {
            mListView.setAdapter(new ArrayAdapter<Datum>(AndroidXMLParsingActivity.this, R.layout.list_item, result));
            AndroidXMLParsingActivity.this.setProgressBarIndeterminateVisibility(false);
        }
    }
